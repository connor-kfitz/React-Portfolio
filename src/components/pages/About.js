            ...
            <div>
                <div id="mainAbout">
                    <div id="aboutMeContainer">
                        <img id="avatarIcon" src={bitmojiIcon} alt="Avater"/>
                        <div id="aboutMeText">
